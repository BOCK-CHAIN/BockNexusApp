...
function* fetchCategoriesApiData(): Generator<any, void, any> {
    try {
        yield put(setLoading());
        const data = yield call(fetchCategoriesData);
        yield put(setData(data));
    } catch (error: any) {
        console.log('API failed, using mock data:', error?.message || 'Failed to fetch categories');
        // Instead of setting error, use mock data to ensure the app works
        yield put(setData(mockCategories));
    }
}
